...
grp_by_country = GROUP finaldata2 BY (country);
 flattened_by_country = FOREACH grp_by_country GENERATE
...
STORE flattened_by_country INTO '/home/hai/outputdata/country';